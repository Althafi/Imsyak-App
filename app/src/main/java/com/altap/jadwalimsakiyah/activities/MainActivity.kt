package com.altap.jadwalimsakiyah.activities
...
import com.altap.jadwalimsakiyah.adapter.MainAdapter
import com.altap.jadwalimsakiyah.adapter.MainAdapter.onSelectData
import com.altap.jadwalimsakiyah.model.ModelMain
import com.altap.jadwalimsakiyah.service.GetAddressIntentService
...
class MainActivity : AppCompatActivity(), onSelectData {
    ...
    private val textJSON: Unit
        get() {
            ...
            progressDialog.show()
            AndroidNetworking.get("http://api.aladhan.com/v1/timingsByCity?city=Jakarta&country=Indonesia&method=11")
    ...
    private val dataJSON: Unit
        get() {
            ...
            progressDialog.setMessage("Mohon tunggu...")
            progressDialog.show()
            AndroidNetworking.get("http://api.aladhan.com/v1/hijriCalendarByCity?city=Jakarta&country=Indonesia&method=11&month=09&year=1444")
                    .setPriority(Priority.HIGH)
                    .build()
                    .getAsJSONObject(object : JSONObjectRequestListener {
                        override fun onResponse(response: JSONObject) {
